...
-   We will be doing trainings on how to use the server, how to take advantage of it using paralell processing, etc
...
-   We will have multiple options for accessing the data:
    ...
    -   On own computers via Nextcloud desktop app, or mounting the drive via Samba
-   Transition of archived projects has already been completed
-   Transtion for active projects to begin happening in January 2024

## emLab Server naming competition

*You* could be the person to name the emLab server!

-   Submit your ideas on the new Slack channel: `#server-naming-competition`
-   Submit names simply by posting them in the channel
